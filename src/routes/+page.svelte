...
<svelte:head>
  <title>Gita Chapters</title>
</svelte:head>

<div class="page">
  <!-- top white nav from site -->
  <header class="top-nav">
    <div class="top-nav-inner">
      <nav class="nav-bar">
        ...
        <div class="nav-right">
          <button class="nav-search" type="button" aria-label="Open search">
  ...
  <main class="content">
    ...
    <section class="chapters-grid">
      {#each chapters as num}
        <a class="chapter-card" href={`/gita/${num}`}>
...
<style>
  ...
  @media (max-width: 800px) {
    .top-nav-inner {
      padding: 0 16px;
      flex-direction: column; /* stack bar + dropdown */
      align-items: stretch;
    }
  ...
  .gita-hero {
    position: relative;
    background-image: url("/images/gita-banner.png"); /* use your big chariot image */
  ...
  .chapter-outer {
    ...
    height: 100%;
    border-radius: 24px;
    border: solid rgb(77, 70, 70) 1px;
    background: #f7f1dc; /* plain bg, no image here */
  ...
  .chapter-inner {
    ...
    width: 160%;
    height: 100%;
    background-image: url("/images/chapter-diamond.jpg");
    background-size: cover;
    background-position: center;
    display: flex;
    align-items: center;
  ...
  .chapter-card:hover .chapter-outer {
